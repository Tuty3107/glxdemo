...
import { faUser, faAngleDown, faClose,faSearch } from '@fortawesome/free-solid-svg-icons';
    ...
    <Container fluid className={cx("container")}>
        <Row className={cx("nav-mobie")} >
            <div className={cx("logo-mobie")}>
                <a href="/"><img alt="logo" src="https://www.galaxycine.vn/website/images/galaxy-logo-mobile.png"/></a>
            </div>
            <div className={cx('secondary-nav-wrapper')}>
                <ul className={cx('secondary-nav')}>
                    <li>
                        <a className={cx('logoLink')} href="#">
                        <FontAwesomeIcon icon={faUser} />Đăng nhập</a>
                    </li>
        ...
        <Row>      
            <div className={cx("sed-nav-mobie")} 
                ...
                <FontAwesomeIcon icon={faClose} className={cx('x-close')}
                ...
                <li className={cx("mbsubnav-1")}> Phim
                    <FontAwesomeIcon icon={faAngleDown} />
                    <ul className={cx("mbsubnav-1-item")}>
                        <li onClick={() =>setLibActive("nav-mobie")}><Link to="/schedule">Phim đang chiếu</Link></li>
                        <li onClick={() =>setLibActive("nav-mobie")}><Link to="/schedule"> Phim sắp chiếu</Link></li>
                    </ul>
                </li>
                <li className={cx("mbsubnav-2")}> Góc điện ảnh
                    <FontAwesomeIcon icon={faAngleDown} />
                    <ul className={cx("mbsubnav-2-item")}>
                        <li onClick={() =>setLibActive("nav-mobie")}><Link  to="/movietype">Thể loại phim</Link></li>
                ...
                <li className={cx("mbsubnav-3")}> Sự kiện
                    <FontAwesomeIcon icon={faAngleDown} />
