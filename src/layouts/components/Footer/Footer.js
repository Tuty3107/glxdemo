...
function Footer() {
  return (
    <div className={cx("wrapper")} style={{marginTop: "50px"}}>
      <Container fluid style={{ backgroundColor: "#1a1a1a", padding: "50px 0" }}>
        <Container className={cx("footer-list")}>
          <Row>
            ...
            <Col lg={3} md={6} xs={6}>
              <li>
                <h1 className={cx("title", "title-connect")}>
                  kết nối galaxy cinema
                </h1>
                <ul className={cx("connect-icons")}>
                  <li>
                    <FontAwesomeIcon
                      className={cx("footer-icon", "fbIcon")}
                      icon={faFacebook}
                    ></FontAwesomeIcon>
                  </li>
                  <li>
            ...
            <Row>
              <Col xs={12} sm={12} md={12} lg={12}>
                ...
                <p>
                  ...
                  Hồng, 23 Phan Chu Trinh, Phường Phan Chu Trinh, Quận Hoàn
                  Kiếm, Hà Nội
                </p>
              </Col>
            </Row>
